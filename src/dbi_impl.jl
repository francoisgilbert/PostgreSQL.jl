...
function escapeliteral(db::PostgresDatabaseHandle, value::Union{String, String})
...
function escapeidentifier(db::PostgresDatabaseHandle, value::Union{String, String})
